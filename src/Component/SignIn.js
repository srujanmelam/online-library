...
function SignIn() {
    ...
    return ( <
        div >
        <
        Grid container minWidth = "100vh"
        style = {
            { border: "solid", minWidth: "100%", height: "100vh" } } >
        <
        Grid item xs = { 12 }
        md = { 7 }
        lg = { 7 } >
        <
        img src = "https://c4.wallpaperflare.com/wallpaper/417/445/320/anime-original-book-chair-library-hd-wallpaper-preview.jpg"
        style = {
            { width: "100%", height: "100%", objectfits: "cover" } }
        alt = "brand" /
        >
        <
        /Grid>{" "} <
        ...
        <
        img src = "https://cdn5.vectorstock.com/i/thumb-large/75/49/panda-book-read-newspaper-negative-space-logo-icon-vector-39827549.jpg"
        width = { 200 }
        alt = "logo"
        style = {
            { borderRadius: "50%" } }
